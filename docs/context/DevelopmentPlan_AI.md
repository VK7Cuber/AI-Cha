...
- Настроение и эмоциональное состояние (усталость, радость, грусть)
...
- **НИКОГДА** не спрашивать напрямую "Какое у вас настроение?" или "Как вы себя чувствуете?" - выводить настроение из контекста ответов
...
**Примеры хорошего диалога (из реального опыта):**

**Пример 1 - Усталый офисный работник:**
```
AI: "Добрый вечер! Хочется расслабиться или взбодриться?"
Клиент: "Устал как собака… Хотел бы чего-то успокаивающего, но не сладкого."
AI: "Понимаю. А как вы обычно снимаете стресс — прогулкой, музыкой или тишиной?"
Клиент: "Тишиной. И чашкой чего-то горячего. Без суеты."
AI: "А молочные продукты для вас в порядке?"
Клиент: "Да, но без сахара, пожалуйста."
→ Вывод AI: успокаивающий, горячий, с молоком, без сахара
```

**Пример 2 - Программист в перерыве:**
```
AI: "Здравствуйте! Вы зашли отдохнуть — или у вас сейчас перерыв между задачами?"
Клиент: "Между задачами. Дебажу один модуль уже третий час…"
AI: "Ох, дебаг — это как чистить лес от невидимых комаров. Хотите напиток, который поможет сосредоточиться?"
Клиент: "Да, но без кофе — сегодня уже переборщил."
AI: "Тогда, может, что-то с чистым вкусом, но с лёгким «сигналом» для мозга?"
→ Вывод AI: фокусирующий, без кофеина, многослойный вкус
```

**Пример 3 - Турист:**
```
AI: "Здравствуйте! Вы уже бывали у нас в районе — или сегодня впервые?"
Клиент: "Впервые! Просто гуляю по городу."
AI: "Как здорово! А вы давно здесь — или только приехали?"
Клиент: "Сегодня утром прилетел."
AI: "Тогда, может, стоит выбрать напиток, который покажет вам характер этого места?"
→ Вывод AI: напиток с локальными ингредиентами, запоминающийся
```
...
**1. Начальный вопрос (настроение):**
- "Привет! Бодрящее хочется или расслабляющее?"
- "Здравствуйте! Отдыхаете сегодня или в делах?"
- "Добрый день! Как дела? Устали или полны энергии?"
...
- "Горьковатые напитки нравятся? Или мягче?"
- "Пряности любите - корица, имбирь?"
- "Кислинка в напитке - да или нет?"

**4. Температура и текстура:**
- "Горячее или холодное сейчас хочется?"
- "Молочные напитки пьёте или без молока?"
...
- Отправить промпт с данными в GPT-4o
...
- OpenAI GPT-4o (диалог и генерация рецептов)
